...
// @ts-ignore
  ...
  var peg$f7 = function(decorator, name, superPart, members) {
// @ts-ignore
      return { 
// @ts-ignore
        type: "Class", 
...
// @ts-ignore
  ...
  var peg$f9 = function(access, meta, params, argsPart, body) {
// @ts-ignore
      return { 
// @ts-ignore
        type: "MetaFunction", 
...
// @ts-ignore
  ...
  var peg$f12 = function(decorator, access, modifier) {
// @ts-ignore
    return {
// @ts-ignore
      type: "GetSetProperty",
...
// @ts-ignore
  ...
  var peg$f47 = function(callee, args, right) {
// @ts-ignore
    return {
// @ts-ignore
      type: "FunctionCall",
...
// @ts-ignore
  ...
  var peg$f48 = function(op, argument) { 
// @ts-ignore
    return { 
// @ts-ignore
      type: "Unary", 
...
// @ts-ignore
  ...
  var peg$f49 = function(property, members) {
// @ts-ignore
    return {
// @ts-ignore
...
return {type: "Literal", value, location: location()}};// @ts-ignore

  var peg$f53 = function(expr) {// @ts-ignore
 return expr };// @ts-ignore

  var peg$f54 = function(elements) { 
// @ts-ignore
    return { 
// @ts-ignore
      type: 'Array', 
...
// @ts-ignore
  ...
  var peg$f56 = function(key, value) {
// @ts-ignore
      return { 
// @ts-ignore
        key, 
...
// @ts-ignore
  ...
  var peg$f57 = function(expr) {// @ts-ignore
 return expr };// @ts-ignore

  var peg$f58 = function(args, block) {
// @ts-ignore
    return {
// @ts-ignore
...
// @ts-ignore
  ...
  var peg$f59 = function(condition, thenExpr, elseExpr) {
// @ts-ignore
      return {
// @ts-ignore
        type: "IfExpression",
...
// @ts-ignore
  ...
  var peg$f60 = function(expr, cases, defaultCase) {
// @ts-ignore
      return {
// @ts-ignore
        type: "Switch",
...
// @ts-ignore
  ...
  var peg$f61 = function(name, params, returnPart, block) {
// @ts-ignore
    return {
// @ts-ignore
...
// @ts-ignore
  ...
  var peg$f62 = function(name, params) {
// @ts-ignore
  return{
// @ts-ignore
    type: "GenericType",
...
// @ts-ignore
  ...
  var peg$f64 = function(name, dimensions) {
// @ts-ignore
  return{
// @ts-ignore
    type: "ArrayType",
...
// @ts-ignore
  ...
  var peg$f65 = function(name, typePart) { 
// @ts-ignore
    return { 
// @ts-ignore
      name, 
// @ts-ignore
      type: typePart? typePart[2] : null,
// @ts-ignore
      location: location(),
    } 
  };// @ts-ignore
...
// @ts-ignore
    s3 = peg$parse_();
// @ts-ignore
    s4 = peg$parseGetProperty();
// @ts-ignore
    if (s4 === peg$FAILED) {
// @ts-ignore
      s4 = peg$parseSetProperty();
    }
// @ts-ignore
    if (s4 !== peg$FAILED) {
// @ts-ignore
...
export type Start = ModuleDeclaration[];
...
export type StructMember = VarDeclaration | StructMethod | StructMetaFunction;
...
export type GetSetModifier = "GetSet" | "Get" | "Set";
...
export type ReturnStatement = {
  type: "ReturnStatement";
  expr: AssignmentExpression | null;
  location: {
    source: string | undefined;
    start: { offset: number; line: number; column: number };
    end: { offset: number; line: number; column: number };
...
export type LoopStatement = WhileLoop | ForeachLoop | ForLoop;
...
export type ForLoop = {
  ...
  step: AssignmentExpression | null;
  block: Block;
  location: {
    source: string | undefined;
    start: { offset: number; line: number; column: number };
...
export type ComputedKey = AssignmentExpression;
export type LambdaExpression = {
  type: "LambdaExpression";
  args: NonNullable<ParameterList | null> | never[];
  block: Block;
  location: {
    source: string | undefined;
    start: { offset: number; line: number; column: number };
...
export type Type = GenericType | TupleType | ArrayType | IDENTIFIER;
...
export type ArgumentList = AssignmentExpression[];
