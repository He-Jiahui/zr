...
// @ts-ignore
  ...
  var peg$f73 = function(expr) {// @ts-ignore
 return expr };// @ts-ignore
...
// @ts-ignore
 ...
 return "\\"; };// @ts-ignore
  ...
  var peg$f107 = function(hex) {// @ts-ignore
 return String.fromCharCode(parseInt(hex.join(''), 16)); };// @ts-ignore

  var peg$f108 = function(hex) {// @ts-ignore
 return String.fromCharCode(parseInt(hex.join(''), 16)); };// @ts-ignore
